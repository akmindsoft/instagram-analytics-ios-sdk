...
#ifndef INSTALIBSDKFRAMEWORK_SWIFT_H
#define INSTALIBSDKFRAMEWORK_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="InstalibSDKFramework",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC20InstalibSDKFramework22LoginWebViewController") SWIFT_AVAILABILITY(ios,introduced=12)
